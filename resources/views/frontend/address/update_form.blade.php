        ...
        <div class="list-group list-group-flush mx-3 mt-4">
          ...
          <a href="{{url('/sepetim')}}" class="list-group-item list-group-item-action"><i class="fas fa-tachometer-alt fa-fw me-3" data-feather="shopping-bag"></i><span>Tüm Siparişlerim</span></a>
            ...
            <div class="col-sm-9 pt-4">
                <form action="{{url("/hesabim/$user->user_id/adreslerim/$address->address_id")}}" method="POST" autocomplete="off" novalidate>
                    @csrf
                    @method("PUT")
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="col-lg-6">
                                <x-checkbox field="is_default" label="Varsayılan" checked="{{$address->is_default == 1}}" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
